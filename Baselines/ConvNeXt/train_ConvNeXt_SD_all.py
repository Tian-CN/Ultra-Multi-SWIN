...
from utils_T_butte import read_split_data, plot_data_loader_image, read_split_data_cross_subjects, read_split_data_cross_subjects_SD
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model.state_dict(), "./weights/ConvNeXt_SD_10_all/model-{}.pth".format(epoch))
    ...
    #保存历史图
    plt.savefig(
        './data/save_data/ConvNeXt_20231108_25cross_selected_multi_auto_SD_10_all/plot/20230925_ConvNeXt_all_s' + str(
    ...
    # 保存历史数据
    savemat(
        './data/save_data/ConvNeXt_20231108_25cross_selected_multi_auto_SD_10_all/data/20230925_ConvNeXt_all_s' + str(
