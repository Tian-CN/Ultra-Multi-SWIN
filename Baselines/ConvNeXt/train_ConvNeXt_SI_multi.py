...
from utils_T import read_split_data, plot_data_loader_image, read_split_data_cross_subjects, read_split_data_cross_subjects_SD
from utils_ConvNeXt import create_lr_scheduler, get_params_groups, train_one_epoch, evaluate
#TZK
...
def main(args):
    ...
    #保存历史图
    plt.savefig(
        './data/save_data/ConvNeXt_20231024_25cross_selected_auto_SI_10_lr_multi/plot/20231024_ConvNeXt_all_s' + str(
    ...
    # 保存历史数据
    savemat(
        './data/save_data/ConvNeXt_20231024_25cross_selected_auto_SI_10_lr_multi/data/20231024_ConvNeXt_all_s' + str(
