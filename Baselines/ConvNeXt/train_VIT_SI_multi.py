...
from utils_T import read_split_data, train_one_epoch, evaluate, plot_data_loader_image, read_split_data_cross_subjects
#TZK
...
def main(args):
    ...
    plt.legend()
    #保存历史图
    plt.savefig('./data/save_data/VIT_20231024_25cross_selected_multi_auto_SI_10_lr_random_multi_20240717/plot/20231024_VIT_all_s' + str(args.all_subj[-1]) + '_val_s' + str(args.val_subj) + '_epochs_' + str(args.epochs) + '.png',bbox_inches='tight')
    # plt.show()
    plt.clf()
    # 保存历史数据
    savemat('./data/save_data/VIT_20231024_25cross_selected_multi_auto_SI_10_lr_random_multi_20240717/data/20231024_VIT_all_s' + str(args.all_subj[-1]) + '_val_s' + str(args.val_subj) + '_epochs_' + str(args.epochs) + '.mat',{'history': history, 'subject_set': args.all_subj, 'subject_set_text': args.val_subj})
    print('done')
...
if __name__ == '__main__':
    for val_subj_ in range(25):
        ...
        parser.add_argument('--data-path', type=str,
                            default="./data/Ultrasound_photos_Pre-processed_selected_all_multi_auto")  # Ultrasound_photos text
        # parser.add_argument('--data-path', type=str,
