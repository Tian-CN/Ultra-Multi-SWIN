...
def main(args):
    ...
    #保存历史图
    plt.savefig(
        './data/save_data/VIT_20231016_25cross_selected_multi_auto_SD_20/plot/20231016_VIT_all_s' + str(
    ...
    # 保存历史数据
    savemat(
        './data/save_data/VIT_20231016_25cross_selected_multi_auto_SD_20/data/20231016_VIT_all_s' + str(
