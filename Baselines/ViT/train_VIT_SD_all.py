...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model.state_dict(), "./weights/VIT_SD_30/model-{}.pth".format(epoch))
    ...
    #保存历史图
    plt.savefig(
        './data/save_data/VIT_20231108_25cross_selected_multi_auto_SD_30_all/plot/20230925_VIT_all_s' + str(
    ...
    # 保存历史数据
    savemat(
        './data/save_data/VIT_20231108_25cross_selected_multi_auto_SD_30_all/data/20230925_VIT_all_s' + str(
