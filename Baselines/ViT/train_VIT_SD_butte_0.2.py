...
def main(args):
    ...
    #保存历史图
    plt.savefig(
        './data/save_data/VIT_20231102_25cross_selected_multi_auto_SD_10_butte_0.2/plot/20231102_VIT_all_s' + str(
    ...
    # 保存历史数据
    savemat(
        './data/save_data/VIT_20231102_25cross_selected_multi_auto_SD_10_butte_0.2/data/20231102_VIT_all_s' + str(
