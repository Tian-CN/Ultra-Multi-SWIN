...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model.state_dict(), "./weights/swin_10_all/model-{}.pth".format(epoch))
    ...
    #保存历史图
    plt.savefig(
        './data/save_data/swin_origin_20231108_25cross_selected_auto_SD_00003_10_all/plot/20230925_test_0.00003_Ultra-SWIN-TANSFORMER_all_s' + str(args.all_subj[-1]) + '_val_s' + str(args.val_subj) + '_epochs_' + str(args.epochs) + '.png',
        bbox_inches='tight')
    # plt.show()
    plt.clf()
    # 保存历史数据
    savemat(
        './data/save_data/swin_origin_20231108_25cross_selected_auto_SD_00003_10_all/data/20230925_test_0.00003_Ultra-SWIN-TANSFORMER_all_s' + str(args.all_subj[-1]) + '_val_s' + str(args.val_subj) + '_epochs_' + str(args.epochs) + '.mat',
