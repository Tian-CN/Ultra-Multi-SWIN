...
def main(args):
    ...
    #保存历史图
    plt.savefig(
        './data/save_data/swin_origin_20231101_25cross_selected_auto_SD_00003_butte_0.4/plot/20231101_test_0.00003_Ultra-SWIN-TANSFORMER_all_s' + str(args.all_subj[-1]) + '_val_s' + str(args.val_subj) + '_epochs_' + str(args.epochs) + '.png',
        bbox_inches='tight')
    # plt.show()
    plt.clf()
    # 保存历史数据
    savemat(
        './data/save_data/swin_origin_20231101_25cross_selected_auto_SD_00003_butte_0.4/data/20231101_test_0.00003_Ultra-SWIN-TANSFORMER_all_s' + str(args.all_subj[-1]) + '_val_s' + str(args.val_subj) + '_epochs_' + str(args.epochs) + '.mat',
