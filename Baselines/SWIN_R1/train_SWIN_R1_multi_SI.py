...
def main(args):
    ...
    #保存历史图
    plt.savefig(
        './data/save_data/swin_origin_20231024_25cross_selected_multi_auto_SI_10_lr_random/plot/20231024_Ultra-SWIN-TANSFORMER_all_s' + str(args.all_subj[-1]) + '_val_s' + str(args.val_subj) + '_epochs_' + str(args.epochs) + '.png',
        bbox_inches='tight')
    # plt.show()
    plt.clf()
    # 保存历史数据
    savemat(
        './data/save_data/swin_origin_20231024_25cross_selected_multi_auto_SI_10_lr_random/data/20231024_Ultra-SWIN-TANSFORMER_all_s' + str(args.all_subj[-1]) + '_val_s' + str(args.val_subj) + '_epochs_' + str(args.epochs) + '.mat',
