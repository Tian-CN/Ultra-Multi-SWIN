...
def main(args):
    ...
    #保存历史图
    plt.savefig(
        './data/save_data/tswin_StepMask_20230528_all_selected_test_res_CB_SI_30/plot/test_scheduler_0.00003_20230528_10_Subject-dependent_dorp_mask_layer_3_Ultra-SWIN-TANSFORMER_all_s' + str(args.all_subj[-1]) + '_val_s' + str(args.val_subj) + '_epochs_' + str(args.epochs) + '.png',
        bbox_inches='tight')
    # plt.show()
    plt.clf()
    # 保存历史数据
    savemat(
        './data/save_data/tswin_StepMask_20230528_all_selected_test_res_CB_SI_30/data/test_scheduler_0.00003_20230528_10_Subject-dependent_dorp_mask_layer_3_Ultra-SWIN-TANSFORMER_all_s' + str(args.all_subj[-1]) + '_val_s' + str(args.val_subj) + '_epochs_' + str(args.epochs) + '.mat',
