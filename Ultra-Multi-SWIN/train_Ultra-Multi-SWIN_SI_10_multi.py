...
def main(args):
    ...
    #保存历史图
    plt.savefig(
        './data/save_data/tswin_StepMask_20230604_all_selected_test_res_CB_SI_10_multi/plot/test_scheduler_0.00003_20230604_20_Subject-dependent_dorp_mask_layer_3_Ultra-SWIN-TANSFORMER_all_s' + str(args.all_subj[-1]) + '_val_s' + str(args.val_subj) + '_epochs_' + str(args.epochs) + '.png',
        bbox_inches='tight')
    # plt.show()
    plt.clf()
    # 保存历史数据
    savemat(
        './data/save_data/tswin_StepMask_20230604_all_selected_test_res_CB_SI_10_multi/data/test_scheduler_0.00003_20230604_20_Subject-dependent_dorp_mask_layer_3_Ultra-SWIN-TANSFORMER_all_s' + str(args.all_subj[-1]) + '_val_s' + str(args.val_subj) + '_epochs_' + str(args.epochs) + '.mat',
...
if __name__ == '__main__':
    ...
    # for val_subj_ in range(7, 25):
        ...
        parser.add_argument('--num_classes', type=int, default=4)   #Ultrasound_photos
        ...
        parser.add_argument('--Subject_independent_Experiment', type=bool,
                            default=True)  # Ultrasound_photos 独立跨受试实现（True），受试者依赖实验（False）
