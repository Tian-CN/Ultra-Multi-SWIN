...
from model_Tmask_shift_filer_StepMask_SoftMax1_test0505_res_combine_once import swin_tiny_patch4_window7_224 as create_model
...
from utils_T import read_split_data, train_one_epoch, evaluate, plot_data_loader_image, read_split_data_cross_subjects, read_split_data_cross_subjects_SD
#TZK
...
def main(args):
    ...
    #保存历史图
    plt.savefig(
        './data/save_data/tswin_StepMask_20230713_all_selected_test_res_CB_once_SD_10/plot/test_scheduler_0.00003_20230713_10_Subject-dependent_dorp_mask_layer_3_Ultra-SWIN-TANSFORMER_all_s' + str(args.all_subj[-1]) + '_val_s' + str(args.val_subj) + '_epochs_' + str(args.epochs) + '.png',
        bbox_inches='tight')
    # plt.show()
    plt.clf()
    # 保存历史数据
    savemat(
        './data/save_data/tswin_StepMask_20230713_all_selected_test_res_CB_once_SD_10/data/test_scheduler_0.00003_20230713_10_Subject-dependent_dorp_mask_layer_3_Ultra-SWIN-TANSFORMER_all_s' + str(args.all_subj[-1]) + '_val_s' + str(args.val_subj) + '_epochs_' + str(args.epochs) + '.mat',
...
if __name__ == '__main__':
    ...
    # for val_subj_ in range(7, 25):
        ...
        parser.add_argument('--epochs', type=int, default=30)       #Ultrasound_photos
        parser.add_argument('--batch-size', type=int, default=128)   #服务器可 64 44 36
        ...
        parser.add_argument('--val_subj', default=[val_subj_])  # Ultrasound_photos 独立跨受试实现中，作为验证集的受试者
        ...
        parser.add_argument('--data-path', type=str,
                            default="./data/Ultrasound_photos_Pre-processed_all_auto_selected")  # Ultrasound_photos text
        # parser.add_argument('--data-path', type=str,
